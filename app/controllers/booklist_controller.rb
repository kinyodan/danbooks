...
class BooklistController < ApplicationController
  ...
  def book
    ...
    #### info ##
    # Since we know the index of the record and this will rarely cnange we assume from the api side we will first get it
    # with the index if the recods have chnaged from the api side we search through the records 
  ...
  def set_books_listed
    ...
    @listed_books_data = listed_books_data[:status] ? listed_books_data[:data] : false
  end
end
